...
import 'package:untitled/timetablemaker.dart';
...
class _TeachersState extends State<Teachers> {
  ...
  final TextEditingController teacherDesignation = TextEditingController();
                            ...
                            if (validateFields()) {
                              ...
                              try {
                                ...
                                await _firestore.collection('Teachers').doc(userId).set({
                                  ...
                                  'Designation': teacherDesignation.text,
                                  'Email': teacheremail.text,
                                  'Status': "Available",
                                });
                                _auth.signOut();
                                        ...
                                        Row(
                                          ...
                                          GestureDetector(
                                              onTap:() {
                                                ...
                                                Navigator.push(
                                                    context,
                                                    MaterialPageRoute(builder: (context) =>  TimetableMaker(Teachersid: docId)));
                                              },
  ...
  bool validateFields() {
    if (teachername.text.isEmpty ||
        ...
        teacherDesignation.text.isEmpty ||
  ...
  Future<void> _showEditDialog(String docId, Map<String, dynamic> teacherData) async {
    ...
    TextEditingController DesignationController = TextEditingController(text: teacherData['Designation']);
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            TextButton(
              child: Text('Update'),
              onPressed: () {
                if (validateFieldss(nameController.text, contactController.text, educationController.text, DesignationController.text)) {
                  updateTeacher(docId, {
  ...
  bool validateFieldss(String name, String contact, String education, String Designation) {
    if (name.isEmpty || contact.isEmpty || education.isEmpty || Designation.isEmpty) {
      showSnackbar("All fields are required.", Colors.red);
      return false;
